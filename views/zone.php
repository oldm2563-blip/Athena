...
require __DIR__ . "/../services/sprints.php";
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <header>
      ...
      <div class="ww"><a class="cr" href="dashboard.php" >back</a></div>

    <div class="project_container">
      
        <?php foreach($output as $out): ?>
        <div class="box2">
           <div class="hi"><h2><?= $out['sprint_name'] ?></h2> <a class="view" href="taskv.php?id=<?= $out['sprint_id'] ?>">view</a></div>
            <div class="creation">
