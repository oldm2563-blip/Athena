...
<script>
    const button = document.getElementById("manage");
    const button_s = document.getElementById("member");
    if("<?php echo $_SESSION['role']?>" === "project chef"){
        button.removeAttribute("hidden");
    }
    if("<?php echo $_SESSION['role']?>" === "member"){
        button_s.removeAttribute("hidden");
    }
</script>
</html>