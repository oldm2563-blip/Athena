<?php
    ...
    require __DIR__ . "/../services/createtsk.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section>
    <form action="" method="POST">
        <div>
            <input type="text" placeholder=" " name="Title" require>
        ...
        <div class="ww"><input type="submit" value="Create"><a class="logout" href="taskv.php?id= <?= $_GET['id'] ?>">Cancel</a></div>
    </form>
</section>
</body>
</html>