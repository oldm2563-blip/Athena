<?php
    ...
    require __DIR__ . "/../services/createpr.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section>
    <form action="" method="POST">
        <div>
            <input type="text" placeholder=" " name="Project" require>
            <label for="Project">Project</label>
        </div>
        <div>
            <select name="type" id="">
                <option value="shortproject">shortproject</option>
                <option value="longproject">longproject</option>
            </select>
        </div>
        <div class="ww"><input type="submit" value="Create"><a class="logout" href="manage.php">Cancel</a></div>
    </form>
</section>
</body>
</html>