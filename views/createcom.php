<?php
    ...
    require __DIR__ . "/../services/createcom.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section>
    <form method="POST">
        <div>
            <input type="text" placeholder=" " name="content" require>
            <label for="Content">Content</label>
        </div>
        <div class="fix"><input type="submit" value="Create"><a href="comment.php?id=id=<?= $_GET['id']?>&idcom=<?= $_GET['idcom'] ?> " class="logout">Cancel</a></div>
    </form>
</section>
</body>
</html>